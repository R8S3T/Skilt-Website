...
const Landing: React.FC = () => {
    return (
        <main className="flex flex-col justify-center items-center h-screen bg-cover bg-center bg-my-mud" style={{ backgroundImage: "url('images/background.png')", backgroundSize: 'cover', backgroundPosition: 'center bottom'  }}>
